...
function esPositivo(num) {if (num > 0)
{return "Es positivo";} else if (num < 0) 
{return "Es negativo";} else {return(false);}
...
function obtenerAreaRectangulo(alto, ancho) {return ancho * alto;
